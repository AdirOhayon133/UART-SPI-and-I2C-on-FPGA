...
constant data: std_logic_vector(11 downto 0):="011111111111";
...
next_state_process: process(spi_sclk, rst)
begin
if(rst='1') then
...
state_machine: process(present_state, tx_enable, data_index) 
begin
